...
pip-compile "${requirements_dir}/dev.in" -o "${requirements_dir}/dev.txt" --upgrade-package pip-tools > /dev/null
pip-compile "${requirements_dir}/production.in" -o "${requirements_dir}/production.txt" > /dev/null
